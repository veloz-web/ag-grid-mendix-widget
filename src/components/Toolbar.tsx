...
export type CustomButtonIcon = "none" | "plus" | "edit" | "trash" | "refresh" | "download" | "upload" | "check" | "close" | "search" | "settings" | "link" | "copy" | "save" | "mail" | "print";
...
export const Toolbar: React.FC<ToolbarProps> = ({
    ...
    const leftCustomButtons = customButtons.filter(b => b.buttonVisible && b.buttonPosition === "left");
    const rightCustomButtons = customButtons.filter(b => b.buttonVisible && b.buttonPosition === "right");
    ...
    const renderButtonIcon = (icon: CustomButtonIcon) => {
        ...
        const iconPaths: Record<string, string> = {
            ...
            refresh: "M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z",

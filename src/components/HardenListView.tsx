...
export function HardenListView(props: HardenListViewProps): ReactElement {
    ...
    return (
        <div className="aggrid-hardened-list-view">
                ...
                <div key={idx} className="sr-list-item form-horizontal form-horizontal">
                    ...
                    >
                        ...
                        <div className="sr-long-header">
                            <div className={`sr-callout-simple callouttype-null ${getStatusClassName(getValue(item, "Status"))}`}>
                                <div className="sr-callout-grow">
                                    <div className="sr-callout-preview">
                                        <span
                                            className="widget-soarcustomspan fas fa-lock"
                        ...
                        <div className="sr-long-body">
                            ...
                            <div className="sr-long-body-cell focus-cell" style={{ maxWidth: "33%" }}>

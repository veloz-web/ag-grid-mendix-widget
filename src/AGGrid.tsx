        ...
        <div className="aggrid-container">
            ...
            <ViewRenderer
                ...
                display={{
                    ...
                    autoSizeStrategy: (props as any).autoSizeStrategy || "none",
                    skipHeaderOnAutoSize: Boolean((props as any).skipHeaderOnAutoSize),
                    persistColumnWidths: (props as any).persistColumnWidths !== false,
